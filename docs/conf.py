...
# -*- coding: utf-8 -*-
#
# pulsarpy documentation build configuration file, created by
...
htmlhelp_basename = 'pulsarpy-to-dcc-doc'
...
latex_documents = [
    (master_doc, 'pulsarpy-to-dcc.tex', 'pulsarpy-to-dcc Documentation',
...
man_pages = [
    (master_doc, 'pulsarpy-to-dcc', 'pulsarpy-to-dcc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pulsarpy-to-dcc', 'pulsarpy-to-dcc Documentation',
     author, 'pulsarpy-to-dcc', 'One line description of project.',
     'Miscellaneous'),
]
